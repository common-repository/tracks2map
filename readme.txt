...
Stellt alle in deinem Blog genutzen GPX Dateien (also alle GPX Dateien die mit einem Post verknüpft sind) übersichtlich auf einer Google Map Karte dar. 
...
= Ich kann keine gpx Dateien hochladen =

Füge das in der functions.php ein:
`
